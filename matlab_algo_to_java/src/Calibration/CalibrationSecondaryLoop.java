...
//		sizeOfData = 4;
		...
		if (isDebug) {
			...
			Utils.printArray(o1_val);
			Utils.printArray(o2_val);
		}
		double dotVal = (Utils.dotProduct(o1_val, j1_valf) + Utils.dotProduct(o2_val, j2_valf)) / 2;
		if (isDebug) {
